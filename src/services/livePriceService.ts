...
class LivePriceManager {
  ...
  // 2. High-Precision Organic TradingView-Style Market Momentum & Wave Simulation Engine
  ...
  private async fetchAllLivePricesREST() {
    ...
    // B. Live Forex Exchange Rates via /api/market/forex Real-Time Server Proxy (Zero CORS & Exact TradingView Match)
    try {
    ...
    // C. Spot Gold & Silver via Direct Gold Spot API
