  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm">
        ...
        {/* Mode Selector Tabs */}
        <div className="flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 pb-3 mb-4 overflow-x-auto no-scrollbar scroll-smooth">
          <button
            type="button"
            onClick={() => setDurationModeTab("global")}
            className={`shrink-0 whitespace-nowrap px-4 py-2 rounded-xl text-xs font-bold cursor-pointer transition-all flex items-center gap-2 ${
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar max-w-full pb-1">
            ...
            {[
              ...
              <button
                ...
                className="shrink-0 px-2.5 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-indigo-500 rounded-lg text-[11px] font-bold cursor-pointer transition-all"
              >
                +{q.label}
              </button>
            ))}
